--------------------
     FairyGUI
Copyright © 2014-2025 FairyGUI.com
Version 5.2.0
...
-----------------
5.2.0
1. Fix wrong DisplayObject._renderingOrder.
2. Fix protential ArgumentOutOfRangeException when richtextfield._textChanged is true.
3. Fix the softclip effect of TextMeshPro.
4. Fix protential NaN value of mouse position.
